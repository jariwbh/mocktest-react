                                                        ...
                                                        <div className="col-lg-4">
                                                            <div className="media mb-3">
                                                                ...
                                                                <div className="media-body mt-auto mb-auto">
                                                                    <Link to="/TeacherProfile" className="t-name">{teachers[2].property.fullname}</Link>
                                                                    <div className="">{teachers[2].username}</div>
                                                                    <div className="t-mock-test">Mock Test (90)</div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div className="col-lg-8">
                                                            <div className="mt-tags"><a href="#" >{teachers[2].property.subject[0]}</a> <a href="#" >Maths</a> </div>
                                                        </div>
                                                        <div className="col-lg-12">
                                                            {teachers[2].property.aboutme}
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
