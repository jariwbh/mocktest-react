                    ...
                    <div id="header" className="header-inner fixed-top">
                        <div className="container">
                            <Navbar.Brand>{isAuthenticated() ?
                                <Link to="/Dashboard" className="navbar-brand"><img className="img-fluid" width="70px" height="70px" src={details != null ? details.branchlogo : ''} alt="" /></Link>
                                :
                                <Link to="/" className="navbar-brand"><img className="img-fluid" width="70px" height="70px" src={details != null ? details.branchlogo : ''} alt="" /></Link>
                            }</Navbar.Brand>
